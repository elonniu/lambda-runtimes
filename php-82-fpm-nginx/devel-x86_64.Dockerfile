...
COPY --from=public.ecr.aws/awsguru/nginx:devel-1.23-2023.1.30.1-x86_64 /opt/nginx/bin /opt/nginx/bin
COPY --from=public.ecr.aws/awsguru/nginx:devel-1.23-2023.1.30.1-x86_64 /opt/nginx/conf /opt/nginx/conf
